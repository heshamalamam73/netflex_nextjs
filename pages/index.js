...
export default function Home() {
    ...
    const handleShow =(e)=>{
        ...
        let id = e.target.id
        console.log(id)
        const body = document.getElementsByClassName(styles.ask_item_body)
        if(body[id]){
            return  body[id].classList.toggle(styles.active)
        }else {
            return false
        }
            ...
            <div className={styles.asks}>
                <div className={styles.item_title}>
                    ...
                    <div className={styles.ask_item} >
                        <div className={styles.ask_item_head} id='0'  onClick={handleShow}>
                ...
                <div className={styles.ask_item} >
                        <div className={styles.ask_item_head} id='1' onClick={handleShow}>
                            <div className="ask-btn" >
                ...
                <div className={styles.ask_item} >
                        <div className={styles.ask_item_head} id='2' onClick={handleShow}>
                            <div >
                ...
                <div className={styles.ask_item} >
                        <div className={styles.ask_item_head} id='3' onClick={handleShow} >
                            <div className="ask-btn" >
                                come posso disdire ?
                            </div>
                            <div className='icon'>
                ...
                <div className={styles.ask_item} >
                        <div className={styles.ask_item_head} id='4' onClick={handleShow}>
                            <div className="ask-btn" >
